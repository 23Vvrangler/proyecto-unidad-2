...
class _ReservacionApi implements ReservacionApi {
  ...
  @override
  Future<List<ReservacionModelo>> getAllReservas() async {
  ...
  @override
  Future<ReservacionModelo> getReservaById(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<ReservacionModelo> createReserva(ReservacionModelo reserva) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<ReservacionModelo> updateReserva(ReservacionModelo reserva) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
